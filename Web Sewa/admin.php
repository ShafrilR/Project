      ...
      <div class="container" id="admin">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <button type="button" class="btn btn-sm text-white" data-toggle="modal" data-target="#modal_admin" onclick="Add();" style="background-color : #242424">
              Tambah Data
            </button>
          </div>
            ...
            <div class="modal-content">
              <form action="proses_crud_admin.php" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-footer">
                  ...
                  <button type="submit" name="save_admin" class="btn text-white" style="background-color : #242424">
                    Simpan
                  </button>
                </div>
              </form>
